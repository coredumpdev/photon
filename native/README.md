...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same fourteen charts
...
The same fourteen charts, under four hosts. The CMake host options are off by
