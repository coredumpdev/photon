...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same twenty-three charts
...
The same twenty-three charts, under four hosts. The CMake host options are off by
