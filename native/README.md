...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same twenty-nine charts
...
The same twenty-nine charts, under four hosts. The CMake host options are off by
