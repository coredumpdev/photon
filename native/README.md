...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same nineteen charts
...
The same nineteen charts, under four hosts. The CMake host options are off by
