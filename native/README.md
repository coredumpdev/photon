...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same twelve charts
...
The same twelve charts, under four hosts. The CMake host options are off by
