...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same thirty-three charts
...
The same thirty-three charts, under four hosts. The CMake host options are off by
