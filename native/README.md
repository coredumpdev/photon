...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same eighteen charts
...
The same eighteen charts, under four hosts. The CMake host options are off by
