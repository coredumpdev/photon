...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same twenty-one charts
...
The same twenty-one charts, under four hosts. The CMake host options are off by
