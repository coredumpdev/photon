...
same engine: GLFW, Qt Quick, Qt Widgets and Java, all showing the same sixteen charts
...
The same sixteen charts, under four hosts. The CMake host options are off by
